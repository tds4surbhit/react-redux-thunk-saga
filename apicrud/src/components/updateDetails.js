...
import GetDetailsbyHooks from '../hooks/getdetails'
 


const UpdateDetails = () => {

    const {id} = useParams(); //This basically helps me to get the id's from the url
    console.log("Params Id is __________________ " + id)
